...
//------------------------------------------------
// subtract B from A in log space, i.e. do log(exp(logA)-exp(logB)). Note that logB cannot be greater than logA, if it is the function returns 0 and prints a warning.
